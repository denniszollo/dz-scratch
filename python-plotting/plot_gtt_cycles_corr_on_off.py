...
def select_from_json(path, cycle, start_time, end_time):
  outfile = os.path.join(path, 'gnss-sbp-' + str(cycle) + '.sbp.json')
  cmd_string = ['cat', os.path.join(path, 'gnss-sbp.json'), '|', 'jq -c \'. | select(.time < ', 
...
def setup(path, cycle, nav_df, event_df):
  ...
  end_time_pc = events.iloc[4]['host_time']
...
indir = '/Volumes/data/data/PiksiMultiTesting/2017-09/27-v1.2.5-initial-test-GLO-10hz/LJ14/20170927-152914-lj14-t6-d24h-f4-RTK-CorrOnOff-10m'
indir = '/Volumes/data/data/PiksiMultiTesting/2018-08/08-HDG_5Hz/DUT21/20180809-042312-lj21-t2-d12h-f4-RTK-RFOnOff-1-5s' 
#indir = "/Volumes/data/data/PiksiMultiTesting/2017-10/06-v1.2.11-initial-gpsglo10hz/LJ12/20171006-181639-lj12-t2-d24h-f4-RTK-RFOnOff-1-5s-TL03"
