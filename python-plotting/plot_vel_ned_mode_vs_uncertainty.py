...
plt.subplot(4,1,3)
plt.plot(df2['tow'], df2['h_accuracy']/1000.0, 'x')
plt.ylabel("horizontal velocity uncertainty[m/s]")
plt.subplot(4,1,3)
plt.plot(df2['tow'], df2['v_accuracy']/1000.0, 'x')
plt.ylabel("vertical velocity uncertainty[m/s]")
plt.show()
